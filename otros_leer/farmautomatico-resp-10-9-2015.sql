...
CREATE TABLE `centrosmedicos` (
  ...
  CONSTRAINT `fk_CentrosMedicos_comunas1` FOREIGN KEY (`comunas_idcomunas`) REFERENCES `comunas` (`idcomunas`) ON DELETE NO ACTION ON UPDATE NO ACTION
...
CREATE TABLE `comunas` (
  ...
  KEY `fk_comunas_regiones1_idx` (`regiones_idregiones`),
  CONSTRAINT `fk_comunas_regiones1` FOREIGN KEY (`regiones_idregiones`) REFERENCES `regiones` (`idregiones`) ON DELETE NO ACTION ON UPDATE NO ACTION
...
INSERT INTO `remedios` VALUES ('Aspirina','para el dolor de cabeza','no tomar con alcohol','En lugar fresco y seco','con el alcohol','muy usado'),('Loratadina','para la alergia','no se','En lugar Fresco y seco','ninguna',NULL),('Omeprazol','Para el reflujo','No comer por un rato','En lugar Fresco y seco','Con la comida','ninguno');
...
INSERT INTO `usuarios` VALUES (1,'Erick','fotoerick.jpg','farmautomatico'),(2,'Jorge','fotojorge.jpg','farmautomatico'),(3,'Yo','fotoyo.jpg','metodologias');
...
-- Dump completed on 2015-09-10 16:48:59
